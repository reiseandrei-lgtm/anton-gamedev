...
| 7 | Хендофф | `gd-handoff` | `scope.md`, approved GDD | `handoff/<slice>.md` | Выбран слайс с гипотезой; критерии Engineering Done и Design Done; список фейков/плейсхолдеров. Дальше — реализация (Unity-плагин, вне этого пайплайна) |
