> Copied from spaceninja/narrative-ink-skills `ink-style/rules.md` (MIT © 2026 Scott Vandehey), itself summarizing inkle's "Writing with ink" (MIT © inkle Ltd). Unmodified except this header. See ATTRIBUTION.md.
